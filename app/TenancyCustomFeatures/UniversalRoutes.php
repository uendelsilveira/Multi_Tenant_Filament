...
namespace App\TenancyCustomFeatures;
...
{
    public static $middlewareGroup = 'universal_guard';
    ...
    public function bootstrap(Tenancy $tenancy): void
    {
        foreach (static::$identificationMiddlewares as $middleware) {
            $middleware::$onFail = function ($exception, $request, $next) {
                if (is_object($exception) && $exception instanceof TenantCouldNotBeIdentifiedException) {
                    throw $exception;
                }
